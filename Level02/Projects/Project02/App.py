...
interpreter = tf.lite.Interpreter(model_path="/Users/macbookpro/SHAI/Level02/Projects/deployment/Covid19-X-Ray-Classification/App/main.tflite")
...
# Define class names
class_names = ['Covid', 'Virus', 'Normal']

st.set_page_config(page_title="Chest X-ray Covid19 Classifier", layout="wide")
col1, col2 = st.columns([1, 1])  # Divide the page into two columns

# Left column - Image upload
with col1:
    st.title('Chest X-ray Covid19 Classifier')
    st.markdown('<h3 style="font-weight:normal;">Classify Chest X-ray images into COVID-19, Virus, or Normal.</h3>', unsafe_allow_html=True)
